...
* **Home or away game?** | Related to the previous: Chosing a topic where you have background knowledge and/or a passion in can make make everything easier. On the other hand: Taking the harder route and chosing a topic where you have less domain knowledge can make quite an impression in the eyes of future employers who see that you're versatile when it comes to handling data- and might make your project journey more interesting.
...
* planning your iterations as sprints may help you keep on track
...
* **Regarding the presentation**
  ...
  * test every component and step of your demo. Make sure your demo will run smoothly. Rehearse what you will say, show, demonstrate at a reasonable pace (preferably with an audience)
  * make sure you can work with the **remote tools** (Zoom) to control your presentation (share screen), perhaps share sound, use annotations or the pointer, etc.). Feel free to use the zoom classroom to rehearse this in the week before the presentation
  * the day before all presentations start, we will give you the opportunity for a final rehearsal in a breakout room in front of a member of the teaching team. This is optional, but a lot of students had a good experience with that in the past.
...
You are free to use any data sources from Kaggle, UCI ML Repository, data.gov, public APIs, websites, etc. However, you will need to spend more time searching for and evaluating the quality and complexity of any data set you want to use. Discuss with your instructor as early as possible regarding your project ideas in order to avoid potential blockers. Be aware that a big data set could involve more processing power than your laptop is designed for - consider alternatives or over scope the time to run each phase. 

In the following chapters you'll find various datasources. As examples, we will explain some of them and why they could be useful in your final project
...
* when you face the situation of having to perform a job on a "huge thing" , assume that can be separated into individual pieces, such as:
